        ...
        <!-- AUTO-COMPLETE COM PESQUISA-->
        <script src="assets/aucomplete/js/jquery-1.11.3.min.js"></script>
        <!--<script src="assets/aucomplete/js/bootstrap.min.js"></script>-->
        <script src="assets/aucomplete/js/tabcomplete.min.js"></script>
        <script src="assets/aucomplete/js/livefilter.min.js"></script>
        <script src="assets/aucomplete/js/bootstrap-select.js"></script>
        <script src="assets/aucomplete/js/filterlist.js"></script>
        <script src="assets/aucomplete/js/plugins.js"></script>
        ...
        <!-- Form wizard -->
        <script src="admin/assets/plugins/bootstrap-wizard/jquery.bootstrap.wizard.js"></script>
