                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">CADASTRO COMISSÃO</h4>
                            </li>
                        </ul>
                    </div><!-- end container -->
                </div><!-- end navbar -->
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <h1 class="panel-title"> <i class="fas fa-user-friends"></i>CADASTRO COMISSÃO</h1>
                                            
                                    <form action="comissao/gravar_.php" method="post">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label>Tipo</label>  
                                                    <input type="text" name="tipo" class="form-control" placeholder="Tipo da comissao">
                                                </div>
                                                </div><!-- end col -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="comissao" class="form-control" placeholder="Comissão em %" >
                                                </div>
                                                </div>
